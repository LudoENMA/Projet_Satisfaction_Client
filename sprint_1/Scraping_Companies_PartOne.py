...
# RECUPERATION MANUELLE DES DONNEES # Instancitation du webdriver
try:
...
def get_infos_company(n_company):  # on va chager celle-ci pour ne récupérer qu'une seule liste désormais
    ...
    # Le fait que l'on ne connaissent pas la longeur de la liste à l'avance est plus complexe si le nombre d'élément au
...
for element in liste_categorie_page_1:
...
print(df_company)
df_company.to_csv("infos_company3.csv")  # infos_compagny2 : TMIN = 2 / TMAX = 3 / Toutes les sociétés de la page 1
